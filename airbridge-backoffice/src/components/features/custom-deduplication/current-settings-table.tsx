...
export function CurrentSettingsTable({ settings, onDelete }: CurrentSettingsTableProps) {
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            이 앱에 등록된 중복 제거 규칙 목록입니다. 각 행의 Dedup Key는 Platform + Event Type 조합으로 자동 생성되며, Window는 중복으로 간주하는 시간(초)입니다.
          </p>
        </CardHeader>
        <CardContent>
          {settings.length === 0 ? (
