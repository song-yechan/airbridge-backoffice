...
export const COLLECTION_EVENT_SOURCES = [
  "app 9160",
  "app 9161",
  "app 9162",
  "app 9167",
...
export const COLLECTION_SQL = `SELECT
    date_start AS dt,
    event_source,
    event_category,
...
// 사용 가능한 이벤트 목록
export const AVAILABLE_EVENTS: EventChip[] = [
  { id: "9161", label: "9161" },
...
// Report Usage 데이터
export const REPORT_USAGE_APIS = [
  "actuals_v5_1",
  "funnel_v1_2",
  "retention_v5",
  "revenue_v4",
...
export const REPORT_USAGE_DATA = [
...
export const REPORT_USAGE_SQL = `SELECT
...
AND query LIKE '%%:event_id%%'
GROUP BY 1, 2 ORDER BY 1, 2`;

// Postback 데이터
export const POSTBACK_TARGETS = [
  "appier",
  "fb.biz",
  "fb.audit",
  "google.adw",
...
export const POSTBACK_SQL = `SELECT
...
AND DATA__REQUEST__TIMESTAMP >= :date_from
AND DATA__REQUEST__TIMESTAMP < :date_to
AND DATA__REQUEST__TARGET NOT IN ('google.adwords', 'google.adwords.crossnetwork')
AND DATA__EVENTDATA__CATEGORY IN (':event_id')
